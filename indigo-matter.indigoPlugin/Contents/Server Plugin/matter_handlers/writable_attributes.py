...
WRITABLE_ATTRIBUTES: dict[int, frozenset] = {
    ...
    0x0101: frozenset({0x0004, 0x0005, 0x0006, 0x0029, 0x002A}),
    0x0102: frozenset({0x0017}),
    0x0200: frozenset({0x0015, 0x0017, 0x0020, 0x0021}),
    0x0201: frozenset({0x0010, 0x0011, 0x0012, 0x0013, 0x0014, 0x0015, 0x0016, 0x0017, 0x0018, 0x001A, 0x001B, 0x001C, 0x0023, 0x0024, 0x003A, 0x0040, 0x0042, 0x0043, 0x0044, 0x0045, 0x0047}),
    0x0202: frozenset({0x0000, 0x0002, 0x0005, 0x000B}),
